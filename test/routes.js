...
describe('/characters', function() {
  ...
  it('GET responde con un array de todos los personajes', function() {
    ...
    return supertest
      ...
      .expect('Content-Type', /json/)
      .expect(function(res) {
        expect(res.body).to.deep.eql([{name: 'Harry', houseId: 1, lastName: 'Potter', dateOfBirth: '31-07-1980', yearOfBirth: 1980, isMuggle: false, wand: {}, spells: []},
         {name: 'Hermione', houseId: 1, lastName: 'Granger', dateOfBirth: '06-12-1987', yearOfBirth: 1987, isMuggle: false, wand: {}, spells: []},
         {name: 'Draco', houseId: 2, lastName: 'Malfoy', dateOfBirth: '26-07-1990', yearOfBirth: 1990, isMuggle: false, wand: {}, spells: []}]
        );
      });
  });
...
describe('/spells', function() {
    ...
    it('GET responde con todos los hechizos del personaje indicado pasado por body', function() {
      ...
      return supertest
        ...
        .expect('Content-Type', /json/)
        .expect(function(res) {
          expect(res.body).to.eql([{ id: 1, spellName: "Kadabra", description: "es mágico"},
          { id: 2, spellName: "otro", description: "magic"}]); // testeamos la respuesta con el body
        });
    });
    ...
    it('POST agrega un nuevo hechizo al personaje indicado', function() {
      ...
      return supertest
        ...
        .expect(function(res) {
          ...
          expect(model.showSpells("Harry")).to.deep.eql([{ id: 1, spellName: "lamagia", description: "henry potter"}])
        });
    });
    ...
    describe('/wand', function() {
      ...
      it('GET responde con el objeto "wand" del personaje correspondiente', function() {
        ...
        return supertest
          ...
          .expect('Content-Type', /json/)
          .expect(function(res) {
            expect(res.body).to.eql( {wood: "holly", core: "phoenix feather", length: 11}); // testeamos la respuesta con el body
          });
      });
      ...
      it('POST agrega una nueva varita (wand) al personaje indicado', function() {
        ...
        return supertest
          ...
          .expect(function(res) {
            ...
            expect(model.showWand("Harry")).to.deep.eql({wood: "holly", core: "phoenix feather", length: 11})
          });
